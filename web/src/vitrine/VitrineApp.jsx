                ...
                <div className="grid-produtos">
                    ...
                    {!carregando && !erro && produtos.length === 0 && (
                        <p className="aviso-vitrine">
                            Nenhum calçado encontrado. Fale com a loja pelo WhatsApp{' '}
                            {LOJA.whatsappVisivel} — o que não está aqui pode estar na
                            prateleira.
                        </p>
                    )}
                    ...
                    {!carregando &&
                        ...
                        produtos.map((produto) => {
                            ...
                            return (
                                ...
                                >
                                    {ultimosPares && (
                                        <div className="badge-ultimos-pares">Últimos pares!</div>
                                    )}
                                    {quantidade === 0 && (
                            ...
                            <div className="modal-details">
                                ...
                                <div className="modal-secao-info">
                                    ...
                                    <p>
                                        ...
                                        {produtoSelecionado.descricao || DESCRICAO_PADRAO}
                                    </p>
                                </div>
