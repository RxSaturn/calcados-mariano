            ...
            <form className="login-caixa" onSubmit={enviar}>
                ...
                {erro && erro.status === 503 && (
                    <p className="login-erro" role="alert">
                        Este sistema ainda não foi configurado com uma senha. Quem instalou
                        precisa rodar a instalação de novo para definir uma. Não adianta
                        tentar outra senha aqui.
                    </p>
                )}
                ...
                <p className="login-rodape">
                    A vitrine da loja continua aberta em <a href="/">calçados mariano</a>. Só
